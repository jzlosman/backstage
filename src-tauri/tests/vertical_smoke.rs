...
use backstage_app_lib::catalog::{artifact_detail, build_index, markdown_detail};
...
use backstage_core::{
    GeneratedResult, GeneratedView, GenerationMode, OpenSpecProgress, generation_completed,
...
fn disposable_real_repository_completes_the_vertical_read_only_flow() {
    ...
    let bundle = first_index.projects[0]
        ...
        .expect("discovered OpenSpec bundle");
